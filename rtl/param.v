...
`define XTAL_FREQ_HZ            32'd20_000_000
...
`define ROM_ADDR                 32'h9000_0000 //~ 0x9fff_ffff
`define RAM_ADDR                 32'h8000_0000 //~ 0x8fff_ffff
`define UART_ADDR                32'h3000_0000 //~ 0x3fff_ffff

`define ROM_SIZE                 8*1024 //*4=32kB
`define RAM_SIZE                 8*1024 //*4=32KB


// cpu reset pc address
`define RESET_PC_ADDR            `ROM_ADDR
...
`define INST_SET_RV32FD         8'b0000_0100
