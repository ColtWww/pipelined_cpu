...
#
# Generated by Vivado on Sat Mar 02 22:01:35 +0800 2024
...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="G:/FPGA_ZYNQ_IC_Learn/IC/riscv/riscv32_order_pipeline/riscv_zicsrim_cpu/fpga/led.cache/compile_simlib/activehdl"
  fi
